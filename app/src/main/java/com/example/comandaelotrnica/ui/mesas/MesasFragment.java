package com.example.comandaelotrnica.ui.mesas;
...
public class MesasFragment extends Fragment {
    ...
    private String idEmpresa = UsuarioFirebase.getIdentificacaoUsuario();
