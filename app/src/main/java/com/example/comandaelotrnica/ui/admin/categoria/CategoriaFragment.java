package com.example.comandaelotrnica.ui.admin.categoria;
...
public class CategoriaFragment extends Fragment {
    ...
    public void cadastrarCategoria(){
        ...
        if (categoria.isEmpty()){
            ...
            categoriaCardapio.setIdEmpresa(UsuarioFirebase.getIdentificaçãoUsuario());
    ...
    public void listarCategorias(){
        final String idEmpresa = UsuarioFirebase.getIdentificaçãoUsuario();
